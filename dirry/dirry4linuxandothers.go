...
func init(){
mkl.Version("Tricky's Go Units - dirry4linuxandothers.go","17.12.03")
mkl.Lic    ("Tricky's Go Units - dirry4linuxandothers.go","ZLib License")

predata=map[string] string{}
predata["AppSupport"] = os.Getenv("HOME")
